...
<div>
  ...
  if ((get_plugin_setting('research') == 'yes') && (list_user_objects($page_owner->getGUID(), 'research', 0, false, false, false))) { ?>
    <div class="print-block"><h3><?php echo elgg_echo('resume:researches'); ?></h3>
      <?php echo list_user_objects($page_owner->getGUID(), 'research', 0, false, false, false); ?>
    </div> <?php
  }
  
  if ((get_plugin_setting('publication') == 'yes') && (list_user_objects($page_owner->getGUID(), 'publication', 0, false, false, false))) { ?>
    <div class="print-block"><h3><?php echo elgg_echo('resume:publications'); ?></h3>
      <?php echo list_user_objects($page_owner->getGUID(), 'publication', 0, false, false, false); ?>
    </div> <?php
  }
