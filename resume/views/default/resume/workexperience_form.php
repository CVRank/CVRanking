...
function addInput(divName){
     if (counter == limit)  {
          ...
          var bodyText = '<div id="child' + counter + '"><?php echo $divpositions;?><?php echo elgg_echo('resume:work:position'); echo elgg_echo('resume:*');?><input type="text" name="positions[]" value="" class="input-text"/></div>';
          bodyText += '<?php echo $divwages;?><?php echo elgg_echo('resume:work:wage'); echo elgg_echo('resume:*');?><input type="text" name="wages[]" value="" class="input-text"/></div>';
          bodyText += '<?php echo $divhours;?><?php echo elgg_echo('resume:work:hour'); echo elgg_echo('resume:*');?><input type="text" name="hours[]" value="" class="input-text"/></div><br /><br /><div class="clearfloat"></div>';
          bodyText += '<?php echo $divweeks;?><?php echo elgg_echo('resume:work:weeks'); echo elgg_echo('resume:*');?><input type="text" name="weeks[]" value="" class="input-text"/></div>';
          bodyText += '<?php echo $divstarts;?><?php echo elgg_echo('resume:work:starts');?><br />';
          ...
          bodyText += '<?php echo $divends;?><?php echo elgg_echo('resume:work:ends');?><br />';
          ...
          bodyText +=  '<br /><br /><br /> <div align="right"><input type="button" onClick="removeElement(\'parent' + counter + '\', \'child' + counter + '\')" value="<?php echo elgg_echo('resume:work:removefield'); ?>"></div></div><div class="clearfloat"></div><br />';
 ...
 function addInput2(divName){
     if (counternew == limitnew)  {
          ...
          bodyText += '<div style="float:left; width:60%;margin-right:15px"><?php echo elgg_echo('resume:work:structure2');  echo elgg_echo('resume:*');?><br /><input type="text" name="structure2" value="" class="input-text"/></div>';
          bodyText += '<div style="float:left; width:30%;margin-top:5px"><?php echo elgg_echo('resume:work:country');  echo elgg_echo('resume:*');?><br /><select name="country" class="input-pulldown"><?php echo $country_options; ?></select></div><div class="clearfloat"></div><br />'
    bodyText += '<div style="float:left; width:27%; margin-right:15px;"><?php echo elgg_echo('resume:work:currencycap');  echo elgg_echo('resume:*');?><select name="currenycap" class="input-pulldown"><?php echo $currency_options; ?></select></div>'
    bodyText += '<div style="float:left; width:15%; margin-right:15px;"><?php echo elgg_echo('resume:work:incomecap'); ?><br /><input type="text" name="incomecap" value="" class="input-text"/></div>'
    bodyText += '<div style="float:left; width:15%; margin-right:15px;"><?php echo elgg_echo('resume:work:assetcap'); ?><br /><input type="text" name="assetcap" value="" class="input-text"/></div>'
    bodyText += '<div style="float:left; width:14%; margin-right:15px;"><?php echo elgg_echo('resume:work:marketcap'); ?><br /><input type="text" name="marketcap" value="" class="input-text"/></div>'
    bodyText += '<div style="float:left; width:12%;"><?php echo elgg_echo('resume:work:workers'); ?><br /><input type="text"   name="workers"  value="" class="input-text"/></div><div class="clearfloat"></div><br />'
    bodyText += '<div style="float:left; width:98%;"><?php echo elgg_echo('resume:workexperience:industryclass'); echo elgg_echo('resume:*');?><br /><select name="industryclass2" class="input-pulldown"><?php echo $industryclass_options; ?></select></div>'
...
<div class="contentWrapper">
  ...
  <form action="<?php echo $vars['url']; ?>action/<?php echo $action ?>" method="post">
    ...
    <div class="clearfloat"></div><br />
      ...
      echo elgg_view('input/autocomplete', array('internalname' => 'structure', 'match_on' => 'companies', 
   ...
   <div class="clearfloat"></div>
     ...
     <input type="button" value="<?php echo elgg_echo('resume:work:addstructure'); ?>" onClick="addInput2('dynamicInput2');">
   ...
   <div class="clearfloat"></div><br />
     ...
     <div class="contentWrapper resume_contentWrapper" width="716">
      <p><?php echo elgg_echo('resume:work:positions'); 
      echo elgg_echo('resume:*');?>
      ...
      <div style="display:all;" class="collapsible_box resume_collapsible_box">
       ...
       <a href="javascript:void(0);" class="inline_toggler" onclick="$('#resume_work_experience').toggle();"><?php echo elgg_echo('resume:help'); ?></a>
      <div id="resume_work_experience" style="display:none;text_align:left;float:left"><?php echo elgg_echo('resume:workexperience:help'); ?></div>
   ...
   <div class="clearfloat"></div><br />
    ...
    echo elgg_echo('resume:work:wage'); 
      echo elgg_echo('resume:*');
       echo elgg_view('input/text', array('internalname' => "wages[]", 'value' => ""));
       echo "</div>";
       echo $divhours;
    ...
    echo elgg_echo('resume:work:weeks'); 
      echo elgg_echo('resume:*');
       echo elgg_view('input/text', array('internalname' => "weeks[]", 'value' => ""));
       echo "</div>";
       echo $divstarts;
    ...
    echo elgg_echo('resume:work:ends');
       ...
       echo "</div><br /><br /><br /><br /><div class=\"clearfloat\"></div>";
    ...
    echo elgg_echo('resume:work:wage'); 
      echo elgg_echo('resume:*');
       echo elgg_view('input/text', array('internalname' => "wages[]", 'value' => $wages_array[$i]));
       echo "</div>";
       echo $divhours;
    echo elgg_echo('resume:work:hour'); 
      echo elgg_echo('resume:*');
    ...
    echo elgg_echo('resume:work:weeks'); 
      echo elgg_echo('resume:*');
       echo elgg_view('input/text', array('internalname' => "weeks[]", 'value' => $weeks_array[$i]));
       echo "</div>";
       echo $divstarts;
    echo elgg_echo('resume:work:starts');
       echo "<br />";
