...
// set the title
$title = elgg_echo('resume:add:research');
...
if (get_input('id')) {
  ...
  $research = get_entity($gid);
  $area2 .= elgg_view("resume/form/research_form", array('entity' => $research));
} else {
  $area2 .= elgg_view("resume/form/research_form");
}
// layout the page
