...
// set the title
$title = elgg_echo('resume:add:publication');
...
if (get_input('id')) {
  ...
  $publication = get_entity($gid);
  $area2 .= elgg_view("resume/form/publication_form", array('entity' => $publication));
} else {
  $area2 .= elgg_view("resume/form/publication_form");
}
// layout the page
