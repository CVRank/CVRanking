...
if (get_plugin_setting('education', 'resume') == 'yes') {
  ...
  $educations = elgg_get_entities_from_metadata ("startdate", "", "object", "education", $user_guid, 999, 0, "", -1, false);
...
if (get_plugin_setting('workexperience', 'resume') == 'yes') {
  ...
  $workexperiences = elgg_get_entities_from_metadata ("startdate", "", "object", "workexperience", $user_guid, 999, 0, "", -1, false);
